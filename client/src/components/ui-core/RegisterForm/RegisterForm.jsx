...
const RegisterForm = (props) => {
    ...
    const RegisterSchema = Yup.object().shape({
        ...
        name: Yup.string().when(props.currRole, (currRole) => {
            return currRole !== 'Hiker' ?
                ".required('Name needed')" : ''
        }),
        number: Yup.string().when(props.currRole, (currRole) => {
            return currRole !== 'Hiker' ?
                ".required('Phone number needed')" : ''
        }),
        surname: Yup.string().when(props.currRole, (currRole) => {
            return currRole !== 'Hiker' ?
                '.required("Name needed")' : ''
        })
    });
